...
console.log('Numero elementi di charactersNames prima della modifica: ', charactersNames.length)
for (let i = 0; i < charactersNames.length; i++) {
	const characterName = charactersNames[i]
	for (let j = 0; j < femaleCharacters.length; j++) {
		const femaleCharacterName = femaleCharacters[j].name
		if (characterName === femaleCharacterName) {
			charactersNames.splice(i, 1)
		}
	}
}
console.log('Numero elementi di charactersNames dopo della modifica: ', charactersNames.length)
